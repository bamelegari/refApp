# Generated by Django 2.0 on 2017-12-15 19:07
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('person', models.ForeignKey(db_column='id', on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='refdb.Person')),
        ...
        migrations.AddField(
            model_name='game',
            name='assessor',
            field=models.ForeignKey(blank=True, db_column='assessor_id', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='Assessor_person', to='refdb.Person'),
        ),
        migrations.AddField(
            model_name='game',
            name='assignor',
            field=models.ForeignKey(db_column='id', on_delete=django.db.models.deletion.PROTECT, to='refdb.Person'),
        ),
        migrations.AddField(
            model_name='game',
            name='home_team_name',
